...
// CORS - Permitir acesso via IP e domínio (captive portal)
app.use(cors({
    origin: '*', // Captive portal precisa aceitar qualquer origem
    credentials: true,
...
// Arquivos estáticos - sem cache para captive portal
